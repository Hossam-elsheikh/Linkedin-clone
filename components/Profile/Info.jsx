...
//         <div key={key}>
//           <div>
//           {value.profileCover && <img className='object-cover h-48 rounded-t-md w-full' src={value.profileCover} alt="" /> } 
//           </div>
//           <Avatar
//             src={value.profilePicture}
//             sx={{
...
//             </div>
//             <p className='text-gray-600 '>{value.jobTitle}</p>
//             <p className='text-gray-400 text-sm'>{value.location}<Link href='#' className='text-blue-600 font-semibold hover:underline'>Contact info</Link></p>
//             <Link href='#' className='text-blue-600 font-semibold hover:underline text-sm pt-1'>{value.connections}</Link>
//             <div className='flex gap-2 py-3'>
//               <button className='bg-blue-600 text-white rounded-full py-1 font-semibold px-4 hover:bg-blue-800'>Open to</button>
//               <button className='outline outline-1 outline-blue-600 text-gray-600 rounded-full py-1 font-semibold px-4  hover:outline-blue-800 hover:outline-2 hover:bg-blue-100'>Add profile section</button>
